...
public class UserFinishBookHistoryAdapter extends RecyclerView.Adapter<UserFinishBookHistoryAdapter.DriverHistoryViewHolder>{

    private List<DriverHistoryModel> bookingList;

    private UserFinishBookHistoryAdapter.onBookListener onBookListener;



    public UserFinishBookHistoryAdapter(List<DriverHistoryModel> bookingList) {
    ...
    public  void  setOnBookListener (UserFinishBookHistoryAdapter.onBookListener listener){
    ...
    @Override
    public void onBindViewHolder(@NonNull UserFinishBookHistoryAdapter.DriverHistoryViewHolder holder, int position) {
