...
public class UserBookingAcceptedAdapter extends RecyclerView.Adapter<UserBookingAcceptedAdapter.DriverHistoryViewHolder>{
    ...
    public UserBookingAcceptedAdapter(List<DriverHistoryModel> bookingList) {
    ...
    public  void  setOnChatListener (onChatListener listener1){
    ...
    @Override
    public void onBindViewHolder(@NonNull UserBookingAcceptedAdapter.DriverHistoryViewHolder holder, int position) {
    ...
    public class DriverHistoryViewHolder  extends RecyclerView.ViewHolder {
        ...
        public DriverHistoryViewHolder(@NonNull View itemView) {
            ...
            book  = itemView.findViewById(R.id.userclick);
